...
class ProfilContentCreatorPage extends StatefulWidget {
  ...
  @override
  State<ProfilContentCreatorPage> createState() =>
      _ProfilContentCreatorPageState();
}
...
class _ProfilContentCreatorPageState extends State<ProfilContentCreatorPage> {
  ...
  void getChats() async {
    DocumentSnapshot documentSnapshot =
        await DatabaseService('oCj0Mow6UMgnIBU02J9v7L77x7K2').getUserGroups();
              ...
              child: Row(
                children: <Widget>[
                  CircleAvatar(
                    radius: 20,
                    backgroundImage:
                        NetworkImage(groupDocs[index]['groupIcon']),
                  ),
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 8.0),
                        child: Text(
                          '${(groupDocs[index]['members'] as List<dynamic>).length} Membres',
                        ),
                      ),
                    ],
                  )
